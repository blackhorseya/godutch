...
import (
	...
	"github.com/blackhorseya/godutch/internal/pkg/base/netutil"
	"github.com/blackhorseya/godutch/internal/pkg/infra/transports/http/middlewares"
	"github.com/blackhorseya/godutch/internal/pkg/infra/transports/http/middlewares/rate"
...
func NewRouter(o *Options, logger *zap.Logger, init InitHandlers) *gin.Engine {
	...
	defaultCORS.AddAllowedMethods("OPTIONS")
